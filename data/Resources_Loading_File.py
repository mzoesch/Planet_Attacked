...
IMG_HARDENEMY_SHIP_1 = pygame.image.load(os.path.join("resources/graphics", "HardEnemy_Ship_1.png"))
IMG_HARDENEMY_SHIP_2 = pygame.image.load(os.path.join("resources/graphics", "HardEnemy_Ship_2.png"))
IMG_HARDENEMY_SHIP_3 = pygame.image.load(os.path.join("resources/graphics", "HardEnemy_Ship_3.png"))
...
IMG_FASTER_SHOOTING = pygame.image.load(os.path.join("resources/graphics", "Faster_Shooting.png"))
